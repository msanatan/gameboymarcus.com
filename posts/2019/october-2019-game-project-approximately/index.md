...
https://gameboymarcus.itch.io/approximately

## Tech Things

This project was done with [Phaser 3](https://phaser.io) and [TypeScript](http://www.typescriptlang.org). Phaser was not needed for this game as it doesn't need a game loop. However, it was a good opportunity to try Phaser 3's scaling options and see how they work on mobile devices.
