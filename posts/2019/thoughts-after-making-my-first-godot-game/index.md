...
I began playing Megaman Battle Network again... it holds up so well after all these years &hearts;! So the game I created would have its 8-directional movement. Heck, let's just make it a game about viruses. In the end, I came up with [AV: Execute](https://gameboymarcus.itch.io/av-execute).

![Screenshot of AV Execute](/images/posts/av-execute.png)
